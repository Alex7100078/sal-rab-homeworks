function calcShipping(sum, min, shipping) {
    ...
    shippingSum = productsSum == 0 || productsSum >= freeShippingMinSum ? 0 : shippingPrice; // Использовал тернарный оператор для выполнения всех условий,
...
function calcDiscount(sum, min, discount) {
    ...
    let discountSum = productsSum >= discountMinSum ? discountPart / 100 * productsSum : 0; // Использовал тернарный оператор для выполнения всех условий,
